      ...
      <header className="flex w-full items-center">
        <div className="head_btn_left relative flex overflow-hidden">
          ...
          <div
            ...
            } fixed h-screen z-20 top-0 -ml-6 bg-custom-third overflow-y-auto ease-in-out transition-all duration-300`}
          >
            <div
        ...
        >
          ...
          <p
            id="feedback_msg"
            className="flex justify-center items-center text-center text-xs pb-1"
          >
            {t("feedback")}
          </p>
        </div>
